...
## "U: Upgrades" and "T: Trade" were dropped as those screens were frozen
## (Phase 0a, see docs/frozen_systems.md) — those keys do nothing now.
const PROMPT_TEXT: String = "Near Corporate Station — B: Build"
